...
/**
 * Base class that represents a row from the 'street_type' table.
 *
 *
 *
 * @package    propel.generator.Phonebook.Base
 */
abstract class Street_type implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\Phonebook\\Map\\Street_typeTableMap';
    ...
    /**
     * Initializes internal state of Phonebook\Base\Street_type object.
     */
    ...
    /**
     * Compares this with another <code>Street_type</code> instance.  If
     * <code>obj</code> is an instance of <code>Street_type</code>, delegates to
     * <code>equals(Street_type)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setid($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[Street_typeTableMap::COL_ID] = true;
        }
    ...
    public function setvalue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[Street_typeTableMap::COL_VALUE] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : Street_typeTableMap::translateFieldName('id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : Street_typeTableMap::translateFieldName('value', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = Street_typeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Phonebook\\Street_type'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildStreet_typeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see Street_type::setDeleted()
     * @see Street_type::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildStreet_typeQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                Street_typeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $this->modifiedColumns[Street_typeTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . Street_typeTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(Street_typeTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(Street_typeTableMap::COL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'value';
        }

        $sql = sprintf(
            'INSERT INTO street_type (%s) VALUES (%s)',
    ...
    {
        $pos = Street_typeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Street_type'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['Street_type'][$this->hashCode()] = true;
        $keys = Street_typeTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getid(),
    ...
    {
        $criteria = new Criteria(Street_typeTableMap::DATABASE_NAME);

        if ($this->isColumnModified(Street_typeTableMap::COL_ID)) {
            $criteria->add(Street_typeTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(Street_typeTableMap::COL_VALUE)) {
            $criteria->add(Street_typeTableMap::COL_VALUE, $this->value);
        }
    ...
    {
        $criteria = ChildStreet_typeQuery::create();
        $criteria->add(Street_typeTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of \Phonebook\Street_type (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Phonebook\Street_type Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * If this ChildStreet_type is new, it will return
    ...
    public function setStreets(Collection $streets, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($streetsToDelete as $streetRemoved) {
            $streetRemoved->setStreet_type(null);
        }
     ...
     * Otherwise if this Street_type is new, it will return
     * an empty collection; or if this Street_type has previously
     * been saved, it will retrieve related Streets from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Street_type.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildStreet}> List of ChildStreet objects
     */
    public function getStreetsJoinCity(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildStreetQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(Street_typeTableMap::DEFAULT_STRING_FORMAT);
    }
