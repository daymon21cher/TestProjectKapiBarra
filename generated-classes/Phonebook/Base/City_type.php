...
/**
 * Base class that represents a row from the 'city_type' table.
 *
 *
 *
 * @package    propel.generator.Phonebook.Base
 */
abstract class City_type implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\Phonebook\\Map\\City_typeTableMap';
    ...
    /**
     * Initializes internal state of Phonebook\Base\City_type object.
     */
    ...
    /**
     * Compares this with another <code>City_type</code> instance.  If
     * <code>obj</code> is an instance of <code>City_type</code>, delegates to
     * <code>equals(City_type)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setid($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[City_typeTableMap::COL_ID] = true;
        }
    ...
    public function setvalue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[City_typeTableMap::COL_VALUE] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : City_typeTableMap::translateFieldName('id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : City_typeTableMap::translateFieldName('value', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = City_typeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Phonebook\\City_type'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildCity_typeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see City_type::setDeleted()
     * @see City_type::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCity_typeQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                City_typeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(City_typeTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(City_typeTableMap::COL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'value';
        }

        $sql = sprintf(
            'INSERT INTO city_type (%s) VALUES (%s)',
    ...
    {
        $pos = City_typeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['City_type'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['City_type'][$this->hashCode()] = true;
        $keys = City_typeTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getid(),
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(City_typeTableMap::COL_ID)) {
            $criteria->add(City_typeTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(City_typeTableMap::COL_VALUE)) {
            $criteria->add(City_typeTableMap::COL_VALUE, $this->value);
        }
    ...
    {
        $criteria = ChildCity_typeQuery::create();
        $criteria->add(City_typeTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of \Phonebook\City_type (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Phonebook\City_type Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * If this ChildCity_type is new, it will return
     ...
     * Otherwise if this City_type is new, it will return
     * an empty collection; or if this City_type has previously
     * been saved, it will retrieve related Cities from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in City_type.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildCity}> List of ChildCity objects
     */
    public function getCitiesJoinRegion(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCityQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(City_typeTableMap::DEFAULT_STRING_FORMAT);
    }
