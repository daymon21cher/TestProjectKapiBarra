...
abstract class City implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Phonebook\\Map\\CityTableMap';
    ...
    /**
     * The value for the city_type_id field.
     *
     * @var        int|null
     */
    protected $city_type_id;
     ...
     * @var        ChildCity_type
     */
    protected $aCity_type;

    /**
     * @var        ObjectCollection|ChildStreet[] Collection to store aggregation of ChildStreet objects.
     * @phpstan-var ObjectCollection&\Traversable<ChildStreet> Collection to store aggregation of ChildStreet objects.
     */
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildStreet>
     */
    protected $streetsScheduledForDeletion = null;

    /**
     * Initializes internal state of Phonebook\Base\City object.
     */
    ...
    /**
     * Get the [city_type_id] column value.
     *
     * @return int|null
     */
    public function getcity_type_id()
    {
        return $this->city_type_id;
    }
     ...
     * @return $this The current object (for fluent API support)
     */
    public function setregion_id($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->region_id !== $v) {
            $this->region_id = $v;
            $this->modifiedColumns[CityTableMap::COL_REGION_ID] = true;
        }
    ...
    /**
     * Set the value of [city_type_id] column.
     *
     * @param int|null $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setcity_type_id($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->city_type_id !== $v) {
            $this->city_type_id = $v;
            $this->modifiedColumns[CityTableMap::COL_CITY_TYPE_ID] = true;
        }

        if ($this->aCity_type !== null && $this->aCity_type->getid() !== $v) {
            $this->aCity_type = null;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CityTableMap::translateFieldName('region_id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->region_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CityTableMap::translateFieldName('city_type_id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->city_type_id = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = CityTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Phonebook\\City'), 0, $e);
        }
    }
    ...
    public function ensureConsistency(): void
    {
        ...
        if ($this->aCity_type !== null && $this->city_type_id !== $this->aCity_type->getid()) {
            $this->aCity_type = null;
        }
    }
    ...
    protected function doSave(ConnectionInterface $con): int
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aCity_type !== null) {
                if ($this->aCity_type->isModified() || $this->aCity_type->isNew()) {
                    $affectedRows += $this->aCity_type->save($con);
                }
                $this->setCity_type($this->aCity_type);
            }
            ...
            if ($this->streetsScheduledForDeletion !== null) {
                if (!$this->streetsScheduledForDeletion->isEmpty()) {
                    foreach ($this->streetsScheduledForDeletion as $street) {
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(CityTableMap::COL_REGION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'region_id';
        }
        if ($this->isColumnModified(CityTableMap::COL_CITY_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'city_type_id';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'region_id':
                        ...
                        break;
                    case 'city_type_id':
                        $stmt->bindValue($identifier, $this->city_type_id, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function getByPosition(int $pos)
    {
        switch ($pos) {
            ...
            case 2:
                return $this->getregion_id();

            case 3:
                return $this->getcity_type_id();
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            $keys[0] => $this->getid(),
            $keys[1] => $this->getname(),
            $keys[2] => $this->getregion_id(),
            $keys[3] => $this->getcity_type_id(),
        ];
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aCity_type) {
                ...
                $result[$key] = $this->aCity_type->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function setByPosition(int $pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setregion_id($value);
                break;
            case 3:
                $this->setcity_type_id($value);
                break;
        } // switch()
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setregion_id($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setcity_type_id($arr[$keys[3]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(CityTableMap::COL_REGION_ID)) {
            $criteria->add(CityTableMap::COL_REGION_ID, $this->region_id);
        }
        if ($this->isColumnModified(CityTableMap::COL_CITY_TYPE_ID)) {
            $criteria->add(CityTableMap::COL_CITY_TYPE_ID, $this->city_type_id);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Phonebook\City (or compatible) type.
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setregion_id($this->getregion_id());
        $copyObj->setcity_type_id($this->getcity_type_id());
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Phonebook\City Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    {
        if ($v === null) {
            $this->setregion_id(NULL);
        } else {
            $this->setregion_id($v->getid());
        }
     ...
     * @return ChildRegion|null The associated ChildRegion object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getRegion(?ConnectionInterface $con = null)
    {
        if ($this->aRegion === null && ($this->region_id != 0)) {
    ...
    /**
     * Declares an association between this object and a ChildCity_type object.
     *
     * @param ChildCity_type|null $v
     * @return $this The current object (for fluent API support)
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function setCity_type(ChildCity_type $v = null)
    {
        if ($v === null) {
            $this->setcity_type_id(NULL);
        } else {
            $this->setcity_type_id($v->getid());
        }

        $this->aCity_type = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildCity_type object, it will not be re-added.
        if ($v !== null) {
            $v->addCity($this);
        }
    ...
    /**
     * Get the associated ChildCity_type object
     *
     * @param ConnectionInterface $con Optional Connection object.
     * @return ChildCity_type|null The associated ChildCity_type object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getCity_type(?ConnectionInterface $con = null)
    {
        if ($this->aCity_type === null && ($this->city_type_id != 0)) {
            $this->aCity_type = ChildCity_typeQuery::create()->findPk($this->city_type_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCity_type->addCities($this);
             */
        }

        return $this->aCity_type;
    }
     ...
     * @return void
     */
    public function resetPartialStreets($v = true): void
    {
     ...
     * @return void
     */
    public function initStreets(bool $overrideExisting = true): void
    {
        ...
        $this->collStreets->setModel('\Phonebook\Street');
    }
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildStreet> List of ChildStreet objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
        ...
        if (null === $this->collStreets || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collStreets) {
                    ...
                    $collStreets = new $collectionClassName;
                    $collStreets->setModel('\Phonebook\Street');
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countStreets(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collStreetsPartial && !$this->isNew();
        if (null === $this->collStreets || null !== $criteria || $partial) {
     ...
     */
    protected function doAddStreet(ChildStreet $street): void
    {
    ...
    public function removeStreet(ChildStreet $street)
    {
        if ($this->getStreets()->contains($street)) {
            ...
            $this->streetsScheduledForDeletion[]= $street;
            $street->setCity(null);
        }
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildStreet}> List of ChildStreet objects
     */
    public function getStreetsJoinStreet_type(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildStreetQuery::create(null, $criteria);
        $query->joinWith('Street_type', $joinBehavior);
    ...
    {
        if (null !== $this->aRegion) {
            $this->aRegion->removeCity($this);
        }
        if (null !== $this->aCity_type) {
            $this->aCity_type->removeCity($this);
        }
        $this->id = null;
        $this->name = null;
        $this->region_id = null;
        $this->city_type_id = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
        $this->resetModified();
        $this->setNew(true);
