...
abstract class Person implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Phonebook\\Map\\PersonTableMap';
    ...
    /**
     * Initializes internal state of Phonebook\Base\Person object.
     */
     ...
     * @return $this The current object (for fluent API support)
     */
    public function setfirst_name($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->first_name !== $v) {
            $this->first_name = $v;
            $this->modifiedColumns[PersonTableMap::COL_FIRST_NAME] = true;
        }
     ...
     * @return $this The current object (for fluent API support)
     */
    public function setlast_name($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->last_name !== $v) {
            $this->last_name = $v;
            $this->modifiedColumns[PersonTableMap::COL_LAST_NAME] = true;
        }
    ...
    public function setphone($v)
    {
        ...
        if ($this->phone !== $v) {
            $this->phone = $v;
            $this->modifiedColumns[PersonTableMap::COL_PHONE] = true;
        }
     ...
     * @return $this The current object (for fluent API support)
     */
    public function setaddress_id($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->address_id !== $v) {
            $this->address_id = $v;
            $this->modifiedColumns[PersonTableMap::COL_ADDRESS_ID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PersonTableMap::translateFieldName('first_name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->first_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PersonTableMap::translateFieldName('last_name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->last_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PersonTableMap::translateFieldName('phone', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PersonTableMap::translateFieldName('address_id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Phonebook\\Person'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(PersonTableMap::COL_FIRST_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'first_name';
        }
        if ($this->isColumnModified(PersonTableMap::COL_LAST_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'last_name';
        }
        if ($this->isColumnModified(PersonTableMap::COL_PHONE)) {
            $modifiedColumns[':p' . $index++]  = 'phone';
        }
        if ($this->isColumnModified(PersonTableMap::COL_ADDRESS_ID)) {
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            $keys[0] => $this->getid(),
            $keys[1] => $this->getfirst_name(),
            $keys[2] => $this->getlast_name(),
            $keys[3] => $this->getphone(),
            $keys[4] => $this->getaddress_id(),
        ];
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setfirst_name($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setlast_name($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setphone($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setaddress_id($arr[$keys[4]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(PersonTableMap::COL_FIRST_NAME)) {
            $criteria->add(PersonTableMap::COL_FIRST_NAME, $this->first_name);
        }
        if ($this->isColumnModified(PersonTableMap::COL_LAST_NAME)) {
            $criteria->add(PersonTableMap::COL_LAST_NAME, $this->last_name);
        }
        if ($this->isColumnModified(PersonTableMap::COL_PHONE)) {
            $criteria->add(PersonTableMap::COL_PHONE, $this->phone);
        }
        if ($this->isColumnModified(PersonTableMap::COL_ADDRESS_ID)) {
            $criteria->add(PersonTableMap::COL_ADDRESS_ID, $this->address_id);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Phonebook\Person (or compatible) type.
    ...
    {
        $copyObj->setfirst_name($this->getfirst_name());
        $copyObj->setlast_name($this->getlast_name());
        $copyObj->setphone($this->getphone());
        $copyObj->setaddress_id($this->getaddress_id());
        if ($makeNew) {
            $copyObj->setNew(true);
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Phonebook\Person Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    {
        if (null !== $this->aAddress) {
            $this->aAddress->removePerson($this);
        }
        $this->id = null;
