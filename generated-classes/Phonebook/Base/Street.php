...
/**
 * Base class that represents a row from the 'street' table.
 *
 *
 *
...
abstract class Street implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Phonebook\\Map\\StreetTableMap';
    ...
    /**
     * The value for the street_type_id field.
     *
     * @var        int|null
     */
    protected $street_type_id;
    ...
    /**
     * @var        ChildStreet_type
     */
    protected $aStreet_type;

    /**
     * @var        ObjectCollection|ChildAddress[] Collection to store aggregation of ChildAddress objects.
     * @phpstan-var ObjectCollection&\Traversable<ChildAddress> Collection to store aggregation of ChildAddress objects.
     */
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildAddress>
     */
    protected $addressesScheduledForDeletion = null;

    /**
     * Initializes internal state of Phonebook\Base\Street object.
     */
    ...
    /**
     * Get the [street_type_id] column value.
     *
     * @return int|null
     */
    public function getstreet_type_id()
    {
    ...
    public function setid($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[StreetTableMap::COL_ID] = true;
        }
    ...
    public function setname($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[StreetTableMap::COL_NAME] = true;
        }
    ...
    /**
     * Set the value of [street_type_id] column.
     *
     * @param int|null $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setstreet_type_id($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->street_type_id !== $v) {
            $this->street_type_id = $v;
            $this->modifiedColumns[StreetTableMap::COL_STREET_TYPE_ID] = true;
        }

        if ($this->aStreet_type !== null && $this->aStreet_type->getid() !== $v) {
            $this->aStreet_type = null;
        }
    ...
    public function setcity_id($v)
    {
        ...
        if ($this->city_id !== $v) {
            $this->city_id = $v;
            $this->modifiedColumns[StreetTableMap::COL_CITY_ID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : StreetTableMap::translateFieldName('name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : StreetTableMap::translateFieldName('street_type_id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->street_type_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : StreetTableMap::translateFieldName('city_id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = StreetTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Phonebook\\Street'), 0, $e);
        }
    }
    ...
    {
        if ($this->aStreet_type !== null && $this->street_type_id !== $this->aStreet_type->getid()) {
            $this->aStreet_type = null;
        }
    ...
    protected function doSave(ConnectionInterface $con): int
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aStreet_type !== null) {
                if ($this->aStreet_type->isModified() || $this->aStreet_type->isNew()) {
                    $affectedRows += $this->aStreet_type->save($con);
                }
                $this->setStreet_type($this->aStreet_type);
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $this->modifiedColumns[StreetTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . StreetTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(StreetTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(StreetTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(StreetTableMap::COL_STREET_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'street_type_id';
        }
        if ($this->isColumnModified(StreetTableMap::COL_CITY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'city_id';
        }

        $sql = sprintf(
            'INSERT INTO street (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'name':
                        ...
                        break;
                    case 'street_type_id':
                        $stmt->bindValue($identifier, $this->street_type_id, PDO::PARAM_INT);
                        break;
                    case 'city_id':
    ...
    public function getByPosition(int $pos)
    {
        switch ($pos) {
            ...
            case 2:
                return $this->getstreet_type_id();

            case 3:
                return $this->getcity_id();
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            $keys[0] => $this->getid(),
            $keys[1] => $this->getname(),
            $keys[2] => $this->getstreet_type_id(),
            $keys[3] => $this->getcity_id(),
        ];
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aStreet_type) {
                ...
                $result[$key] = $this->aStreet_type->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function setByPosition(int $pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setstreet_type_id($value);
                break;
            case 3:
                $this->setcity_id($value);
                break;
        } // switch()
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setstreet_type_id($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setcity_id($arr[$keys[3]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(StreetTableMap::COL_ID)) {
            $criteria->add(StreetTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(StreetTableMap::COL_NAME)) {
            $criteria->add(StreetTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(StreetTableMap::COL_STREET_TYPE_ID)) {
            $criteria->add(StreetTableMap::COL_STREET_TYPE_ID, $this->street_type_id);
        }
        if ($this->isColumnModified(StreetTableMap::COL_CITY_ID)) {
            $criteria->add(StreetTableMap::COL_CITY_ID, $this->city_id);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Phonebook\Street (or compatible) type.
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setstreet_type_id($this->getstreet_type_id());
        $copyObj->setcity_id($this->getcity_id());
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Phonebook\Street Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    {
        if ($v === null) {
            $this->setcity_id(NULL);
        } else {
            $this->setcity_id($v->getid());
        }
     ...
     * @return ChildCity|null The associated ChildCity object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildStreet_type object.
     *
     * @param ChildStreet_type|null $v
     * @return $this The current object (for fluent API support)
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function setStreet_type(ChildStreet_type $v = null)
    {
        if ($v === null) {
            $this->setstreet_type_id(NULL);
        } else {
            $this->setstreet_type_id($v->getid());
        }

        $this->aStreet_type = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildStreet_type object, it will not be re-added.
        if ($v !== null) {
            $v->addStreet($this);
        }
    ...
    /**
     * Get the associated ChildStreet_type object
     *
     * @param ConnectionInterface $con Optional Connection object.
     * @return ChildStreet_type|null The associated ChildStreet_type object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getStreet_type(?ConnectionInterface $con = null)
    {
        if ($this->aStreet_type === null && ($this->street_type_id != 0)) {
            $this->aStreet_type = ChildStreet_typeQuery::create()->findPk($this->street_type_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aStreet_type->addStreets($this);
             */
        }

        return $this->aStreet_type;
    }
    ...
    public function initAddresses(bool $overrideExisting = true): void
    {
        ...
        $collectionClassName = AddressTableMap::getTableMap()->getCollectionClassName();

        $this->collAddresses = new $collectionClassName;
        $this->collAddresses->setModel('\Phonebook\Address');
    }
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildAddress> List of ChildAddress objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
        ...
        if (null === $this->collAddresses || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collAddresses) {
                    ...
                    $collAddresses->setModel('\Phonebook\Address');
     ...
     */
    protected function doAddAddress(ChildAddress $address): void
    {
     ...
     * Otherwise if this Street is new, it will return
     * an empty collection; or if this Street has previously
     * been saved, it will retrieve related Addresses from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Street.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildAddress}> List of ChildAddress objects
     */
    public function getAddressesJoinBuilding_type(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildAddressQuery::create(null, $criteria);
        $query->joinWith('Building_type', $joinBehavior);
    ...
    public function clear()
    {
        ...
        if (null !== $this->aStreet_type) {
            $this->aStreet_type->removeStreet($this);
        }
        $this->id = null;
        $this->name = null;
        $this->street_type_id = null;
        $this->city_id = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
        $this->resetModified();
