...
/**
 * Base class that represents a row from the 'building_type' table.
 *
 *
 *
 * @package    propel.generator.Phonebook.Base
 */
abstract class Building_type implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\Phonebook\\Map\\Building_typeTableMap';
    ...
    /**
     * Initializes internal state of Phonebook\Base\Building_type object.
     */
    ...
    /**
     * Compares this with another <code>Building_type</code> instance.  If
     * <code>obj</code> is an instance of <code>Building_type</code>, delegates to
     * <code>equals(Building_type)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setid($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[Building_typeTableMap::COL_ID] = true;
        }
    ...
    public function setvalue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[Building_typeTableMap::COL_VALUE] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : Building_typeTableMap::translateFieldName('id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : Building_typeTableMap::translateFieldName('value', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = Building_typeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Phonebook\\Building_type'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildBuilding_typeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see Building_type::setDeleted()
     * @see Building_type::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildBuilding_typeQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                Building_typeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $this->modifiedColumns[Building_typeTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . Building_typeTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(Building_typeTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(Building_typeTableMap::COL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'value';
        }

        $sql = sprintf(
            'INSERT INTO building_type (%s) VALUES (%s)',
    ...
    {
        $pos = Building_typeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Building_type'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['Building_type'][$this->hashCode()] = true;
        $keys = Building_typeTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getid(),
    ...
    {
        $criteria = new Criteria(Building_typeTableMap::DATABASE_NAME);

        if ($this->isColumnModified(Building_typeTableMap::COL_ID)) {
            $criteria->add(Building_typeTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(Building_typeTableMap::COL_VALUE)) {
            $criteria->add(Building_typeTableMap::COL_VALUE, $this->value);
        }
    ...
    {
        $criteria = ChildBuilding_typeQuery::create();
        $criteria->add(Building_typeTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of \Phonebook\Building_type (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Phonebook\Building_type Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * If this ChildBuilding_type is new, it will return
    ...
    public function setAddresses(Collection $addresses, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($addressesToDelete as $addressRemoved) {
            $addressRemoved->setBuilding_type(null);
        }
     ...
     * Otherwise if this Building_type is new, it will return
     * an empty collection; or if this Building_type has previously
     * been saved, it will retrieve related Addresses from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Building_type.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildAddress}> List of ChildAddress objects
     */
    public function getAddressesJoinStreet(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildAddressQuery::create(null, $criteria);
        $query->joinWith('Street', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(Building_typeTableMap::DEFAULT_STRING_FORMAT);
    }
